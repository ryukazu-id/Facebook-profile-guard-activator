fetch("https://www.facebook.com/api/graphql/", {
    ...
    "body": (function(param){
        ...
        variables: '{\"0\":{\"is_shielded\":false,\"session_id\":\"'+(session_id = document.querySelector('input[name="composer_session_id"]').value)+'\",\"actor_id\":\"'+user_id+'\",\"client_mutation_id\":\"'+session_id+'\"}}',
